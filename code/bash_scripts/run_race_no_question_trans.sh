...
# Train no question model on baseline data
...
--learning_rate 1e-5 \
--num_train_epochs 4 \
--output_dir qa_models/baseline_no_question_transf/ \
--per_gpu_eval_batch_size=16 \
--per_device_train_batch_size=1 \
--save_total_limit 1 \
--overwrite_output

# Evaluate no question model on control data
CUDA_VISIBLE_DEVICES=0 python run_qa.py \
--model_name_or_path qa_models/baseline_no_question_transf/ \
...
--learning_rate 1e-5 \
--num_train_epochs 4 \
--output_dir qa_models/control_no_question_transf/ \
--per_gpu_eval_batch_size=16 \
--per_device_train_batch_size=1 \
--save_total_limit 1 \
--overwrite_output

# Evaluate no question model on sources data
CUDA_VISIBLE_DEVICES=0 python run_qa.py \
--model_name_or_path qa_models/baseline_no_question_transf/ \
...
--learning_rate 1e-5 \
--num_train_epochs 4 \
--output_dir qa_models/sources_no_question_transf/ \
--per_gpu_eval_batch_size=16 \
--per_device_train_batch_size=1 \
--save_total_limit 1 \
--overwrite_output
